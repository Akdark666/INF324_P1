...
// Obtiene el nombre de usuario del estudiante desde la sesión
$usuario_estudiante = $_SESSION['usuario'];

// Consulta para obtener los datos del estudiante
$sql = "SELECT nombre, ci, color FROM estudiante WHERE usuario = '$usuario_estudiante'";
...
<script>
    ...
    xhr.open('POST', 'guardar_color_es.php', true);
